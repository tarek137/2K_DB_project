...
while True:
    ...
    Speed = driver.find_element_by_xpath('//*[@id="__next"]/div[2]/div[4]/div[2]/div[1]/div[1]/span[1]').get_attribute("innerHTML")

    Shoot_threepoint = driver.find_element_by_xpath('//*[@id="__next"]/div[2]/div[4]/div[1]/div[1]/div[3]/span[1]').get_attribute("innerHTML")
...
player_df.to_sql("Players", engine , if_exists='append')
